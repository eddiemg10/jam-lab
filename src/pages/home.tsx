      ...
      {userProfile && (
        <div>
            <div className="flex w-full py-5 items-center justify-between">
                <h1 className="md:text-5xl text-3xl font-medium text-yellow-100 motion-preset-oscillate-sm">Jam Lab</h1>
                <a href={userProfile.uri} target='_blank' className="hover:motion-translate-y-loop-25 motion-loop-once flex items-center gap-x-3 bg-jam-surface/25 hover:bg-jam-surface/20 duration-200 rounded-md py-1 px-10">
                    <img className="w-11 rounded-full" src={userProfile.images[0].url} alt="user" />
