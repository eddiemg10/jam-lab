...
export default function Login() {
  const handleClick = async () => {
    const { code_verifier, code_challenge } =
      await generateCodeVerifierChallengePair();
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-center items-center">
      <div className="md:w-[60%] w-[80%] bg-white rounded-md p-10 flex justify-center items-center">
        <button
          onClick={handleClick}
          className="drop-shadow-lg flex items-center justify-center gap-6 w-full bg-green-500 p-4 rounded-md hover:cursor-pointer text-white font-medium"
        >
